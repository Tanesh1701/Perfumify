...
<body>
    <div class="hero-image">
        ...
        <div id="homeTextContainer">
            <p class = "FirstSectionTitle">The Fantasy Of</p>
            <p class = "FirstSectionTitle">Paradise</p>
            <p class="FirstSectionSubtitle">Energetic aromatic irresistible</p>
            <p class="FirstSectionSubtitle">fragrance for all the ways you play.</p>
        </div>
        <div class="homeButton">
            <a class="homeButtonLink" href="#homeSecondSection">Shop Now</a>
        </div>
    </div>
